...
const NavigationBar = () => {
  const navItems = [
    ...
    },
    {
      ...
      isDropdown: true,
      dropdownItems: [
        { name: 'Security Policy Management', path: '/services/services-1' },
        { name: 'Security Controls Implementation', path: '/services/services-2' },
        { name: 'Security Risk Vulnerability Assessment', path: '/services/services-3' },
        { name: 'Data Management', path: '/services/services-4' },
        { name: 'Audit and Risk Assessment', path: '/services/services-5' },
        { name: 'Monitoring and Incident Response', path: '/services/services-6' },
        { name: 'Awareness and Training', path: '/services/services-7' },
        { name: 'Regulatory Reporting', path: '/services/services-8' },
      ],
    },
    {
      name: 'Pricing',
